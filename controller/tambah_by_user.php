...
if (isset($_POST['aksi'])) {
    if ($_POST['aksi'] == "tambah_by_user") {
        ...
        $query = "UPDATE pengaduan SET nama = '$nama', email = '$email', no_telepon = '$no_telepon', id_kategori = '$kategori', kondisi = '$kondisi', gambar = '$gambar' WHERE id_pengaduan = '$id';";
        $sql = mysqli_query($conn, $query);
