  ...
  <section id="dataPelapor">
    <div class="container-fluid content-pelapor">
      <div class="container mt-5">
        ...
        <h2 class="pt-lg-5">DATA PELAPOR</h2>
        ...
        <div class="table py-4">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <?php
              $query = "SELECT pengaduan.nama, pengaduan.email, pengaduan.no_telepon, kategori_pengaduan.jenis
              FROM pengaduan
              JOIN kategori_pengaduan ON pengaduan.id_kategori = kategori_pengaduan.id_kategori";
