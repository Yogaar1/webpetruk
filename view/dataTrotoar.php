        ...
        <div class="table py-4">
          <table class="table table-striped">
            ...
            <tbody>
              ...
              $query = "SELECT id_pengaduan, nama, email, no_telepon, kondisi, alamat, gambar FROM pengaduan WHERE id_kategori= 7";
              ...
              ?>
                <tr>
                  ...
                  <td><?= $row['alamat']; ?></td>
                  <td>
                    <img src="../img/fotoPelaporan/<?= $row['gambar']; ?>" width="2px">
                  </td>
                  <td>
