...
<body>
    ...
    <div class="container-fluid pelaporan wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5 jalan-rusak">
            <form method="POST" enctype="multipart/form-data" action="../controller/tambah_pengaduan.php">
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <div class="my-3">
                            ...
                            <input type="text" name="no_telepon" class="form-control" id="no_telepon " placeholder="No Telepon Anda..." pattern="[0-9]{12}" required>
                        </div>
                        <div class="my-3">
                        ...
                        <div class="my-3">
                            <button type="submit" name="aksi" value="tambah_pengaduan" class="btn btn-success">Kirim</button>
