  ...
  <section id="dataJalan">
    <div class="container-fluid content-pelapor">
      <div class="container mt-5">
        ...
        <h2 class="pt-lg-5">DATA PENGADUAN LAMPU JALAN</h2>
        ...
        <div class="table py-4">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <?php
              $query = "SELECT id_pengaduan, nama, email, no_telepon, kondisi, alamat, gambar FROM pengaduan WHERE id_kategori= 6";
